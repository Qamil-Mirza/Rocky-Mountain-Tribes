              ...
              <TabsContent value="effects" className="space-y-4">
                <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-start">
                  <div className="space-y-4">
                    ...
                    <p className="text-gray-700">
                      Cold-adapted species could be outcompeted by lower
                      elevation plants that use the extended growing season to
                      monopolize space. Some of these new species will probably
                      be nonnative or weedy, like cheatgrass (Bromus tectorum).
                    </p>
                ...
                <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-start">
                  <div className="space-y-4">
                    ...
                    <p className="text-gray-700">
                      ...
                      urbanization and deforestation, contribute to local
                      climate effects and habitat fragmentation.
                    </p>
                    <h3 className="text-2xl font-bold">
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="flex flex-wrap justify-center mb-6 gap-10">
              <CasestudyCard
                ...
                description="The Ute Mountain Ute Tribe’s farm in southwestern Colorado has suffered major losses due to worsening drought, limited water access, and lack of infrastructure, forcing them to cut back on crops and lay off workers."
